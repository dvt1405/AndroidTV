...
class TVChannelListAdapter : BaseAdapter<TVChannel, ItemChannelBinding>() {
    ...
    override fun bindItem(
        ...
        binding.item = ChannelElement.TVChannelElement(item)
        binding.title.isSelected = true
        binding.logo.loadImgByDrawableIdResName(
            item.logoChannel, item.logoChannel,
